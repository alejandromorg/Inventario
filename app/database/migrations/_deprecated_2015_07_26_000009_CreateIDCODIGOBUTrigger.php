...
class CreateIDCODIGOBUTrigger extends Migration {
	...
	public function up()
	{
         ...
         DB::unprepared('
              CREATE TRIGGER tr_ID_CODIGOBU BEFORE UPDATE ON `inv_codigo_clasificacion` FOR EACH ROW
					BEGIN
	...
	{
		DB::unprepared('DROP TRIGGER `tr_ID_CODIGOBU`');
	}
