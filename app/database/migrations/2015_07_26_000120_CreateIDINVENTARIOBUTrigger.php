...
class CreateIDINVENTARIOBUTrigger extends Migration {
	...
	public function up()
	{
         ...
         DB::unprepared('
              CREATE TRIGGER tr_ID_INVENTARIOBU BEFORE UPDATE ON `inv_producto` FOR EACH ROW
					BEGIN 
	...
	{
		DB::unprepared('DROP TRIGGER `tr_ID_INVENTARIOBU`');
	}
